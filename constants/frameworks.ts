...
export const FRAMEWORKS: Framework[] = [
  {
    ...
    fields: [
      { id: 'role', label: 'Rol (role)', placeholder: 'e.g., You are a senior export financing advisor for EU startups.' },
      { id: 'task', label: 'Taak (task)', placeholder: 'e.g., Write a city guide for business travelers.' },
      { id: 'context', label: 'Context', placeholder: 'e.g., The reader is in Paris for the first time and has 48 hours...' },
      { id: 'constraints', label: 'Randvoorwaarden (constraints)', placeholder: 'e.g., Max 500 words. Use British English.' },
      { id: 'output', label: 'Outputformaat (output)', placeholder: 'e.g., Bulleted itinerary with timestamps.' },
      { id: 'tone', label: 'Toon (tone)', placeholder: 'e.g., Light-hearted, formal,...' },
      { id: 'examples', label: 'Voorbeelden (examples)', placeholder: 'e.g., Add example input and example output.' }
    ],
    example: `## ROLE
...
Use clear and concise language and write in a confident yet friendly tone.`
  },
  {
    ...
    fields: [
      ...
      { id: 'evaluation', label: 'Evaluation', placeholder: 'Enter value for Evaluation...' },
      { id: 'narrowing', label: 'Narrowing', placeholder: 'Enter value for Narrowing...' }
    ],
    example: `## ROLE
...
Schrijf in het Nederlands, max. 800 woorden, gebruik kopjes en lijstjes.`
  },
  {
    ...
    fields: [
      { id: 'context', label: 'Context', placeholder: 'Enter value for Context...' },
      { id: 'objective', label: 'Objective', placeholder: 'Enter value for Objective...' },
      { id: 'style', label: 'Style', placeholder: 'Enter value for Style...' },
      { id: 'tone', label: 'Tone', placeholder: 'Enter value for Tone...' },
      { id: 'audience', label: 'Audience', placeholder: 'Enter value for Audience...' },
      { id: 'response', label: 'Response', placeholder: 'Enter value for Response...' }
    ],
    example: `## CONTEXT
...
1) Hook; 2) drie concrete resultaten; 3) mini-case; 4) duidelijke CTA met datum/locatie; 5) vijf relevante hashtags.`
  },
  {
    ...
    fields: [
      { id: 'context', label: 'Context', placeholder: 'Enter value for Context...' },
      { id: 'action', label: 'Action', placeholder: 'Enter value for Action...' },
      { id: 'result', label: 'Result', placeholder: 'Enter value for Result...' },
      { id: 'example', label: 'Example', placeholder: 'Enter value for Example...' }
    ],
    example: `## CONTEXT
...
- **Databronnen:** Studentinformatiesysteem (SIS), LMS-logs, roosterdata, mentorgesprekken (geanonimiseerd).`
  },
  {
    ...
    fields: [
      { id: 'action', label: 'Action', placeholder: 'Enter value for Action...' },
      { id: 'purpose', label: 'Purpose', placeholder: 'Enter value for Purpose...' },
      { id: 'expectation', label: 'Expectation', placeholder: 'Enter value for Expectation...' }
    ],
    example: `## ACTION
...
Noem drie concrete benefits en sluit af met één simpele CTA (antwoord met voorkeursdatum). Taal: NL, toon: professioneel.`
  },
  {
    ...
    fields: [
      { id: 'role', label: 'Role', placeholder: 'Enter value for Role...' },
      { id: 'task', label: 'Task', placeholder: 'Enter value for Task...' },
      { id: 'format', label: 'Format', placeholder: 'Enter value for Format...' }
    ],
    example: `## ROLE
...
1) High-level review (bulletpoints); 2) refactor-codeblok; 3) korte load-testsuggesties. Max. 350 woorden.`
  },
  {
    ...
    fields: [
      { id: 'challenge', label: 'Challenge', placeholder: 'Enter value for Challenge...' },
      { id: 'limitation', label: 'Limitation', placeholder: 'Enter value for Limitation...' },
      { id: 'effect', label: 'Effect', placeholder: 'Enter value for Effect...' },
      { id: 'action', label: 'Action', placeholder: 'Enter value for Action...' },
      { id: 'result', label: 'Result', placeholder: 'Enter value for Result...' }
    ],
    example: `## CHALLENGE
...
Nieuw draaiboek met tijdsindeling, meetbare leeruitkomsten en een exit-ticket (drie vragen). Max. 600 woorden.`
  },
  {
    ...
    fields: [
      { id: 'before', label: 'Before', placeholder: 'Enter value for Before...' },
      { id: 'after', label: 'After', placeholder: 'Enter value for After...' },
      { id: 'bridge', label: 'Bridge', placeholder: 'Enter value for Bridge...' }
    ],
    example: `## BEFORE
...
Schrijf een landingspagina-tekst (hero, social proof, drie value-blocks met bewijs, korte FAQ, CTA) in helder NL, max. 300 woorden.`
  },
  {
    ...
    fields: [
      { id: 'role', label: 'Role', placeholder: 'Enter value for Role...' },
      { id: 'objective', label: 'Objective', placeholder: 'Enter value for Objective...' },
      { id: 'details', label: 'Details', placeholder: 'Enter value for Details...' },
      { id: 'examples', label: 'Examples', placeholder: 'Enter value for Examples...' },
      { id: 'sense_check', label: 'Sense-check', placeholder: 'Enter value for Sense-check...' }
    ],
    example: `## ROLE
